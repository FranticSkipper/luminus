...
// --- Icons ---
import { CornerDownLeftIcon } from "@entities/tiptapEditor/components/tiptap-icons/corner-down-left-icon";
import { ExternalLinkIcon } from "@entities/tiptapEditor/components/tiptap-icons/external-link-icon";
import { LinkIcon } from "@entities/tiptapEditor/components/tiptap-icons/link-icon";
import { TrashIcon } from "@entities/tiptapEditor/components/tiptap-icons/trash-icon";
...
import {
  ...
  PopoverContent,
  PopoverTrigger,
} from "@entities/tiptapEditor/components/tiptap-ui-primitive/popover";
import { Separator } from "@entities/tiptapEditor/components/tiptap-ui-primitive/separator";
