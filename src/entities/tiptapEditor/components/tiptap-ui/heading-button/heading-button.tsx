...
// --- Icons ---
import { HeadingOneIcon } from "@entities/tiptapEditor/components/tiptap-icons/heading-one-icon";
import { HeadingTwoIcon } from "@entities/tiptapEditor/components/tiptap-icons/heading-two-icon";
import { HeadingThreeIcon } from "@entities/tiptapEditor/components/tiptap-icons/heading-three-icon";
import { HeadingFourIcon } from "@entities/tiptapEditor/components/tiptap-icons/heading-four-icon";
import { HeadingFiveIcon } from "@entities/tiptapEditor/components/tiptap-icons/heading-five-icon";
import { HeadingSixIcon } from "@entities/tiptapEditor/components/tiptap-icons/heading-six-icon";

// --- Lib ---
import { isNodeInSchema } from "@entities/tiptapEditor/lib/tiptap-utils";
